...
SYSTEM_PROMPT: str = (
    ...
    "- image_url (string URL lengkap ke gambar poster utama/hero, "
    "opsional — null kalau tidak ada)\n\n"
    "ATURAN:\n"
    ...
    "4. Untuk image_url: cari URL gambar pertama/terbesar di markdown "
    "(biasanya di awal halaman, alt text mengandung 'poster'/'hero'/'thumbnail' "
    "atau nama lomba). Kalau tidak ada gambar eksplisit, return null.\n"
    "5. Kembalikan HANYA JSON object dengan key 'competitions' berisi array. "
